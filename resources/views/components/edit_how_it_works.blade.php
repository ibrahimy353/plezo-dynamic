...
@section('content')
    <div class="container">
        ...
        @endif
        <form action="{{ route('update_how_it_works', $hero->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <a href="{{ route('view_how_it_works') }}" class="btn btn-secondary">Back</a>
        </form>
    </div>
@endsection
